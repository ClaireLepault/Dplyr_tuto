...
Most of these slides come from the courses offered by [Ed Rubin](http://edrub.in/) ([@EC607](https://github.com/edrubin/EC607S23)) and [Grant MacDermott](https://grantmcdermott.com/) ([@EC607](https://github.com/uo-ec607/lectures)).
...
```{R, df_storms}
storms[1:8,c(1:8, 10:11)] %>% data.frame()
```
...
--
Display the number of rows and columns of the `storms` dataset: 
...
Combining `mutate` with the `across` feature allows you to easily work on a subset of variables. For example:
